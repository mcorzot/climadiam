#' @title Obtener datos anuales a partir de los identificadores internos de
...
#' pkests <- c('2306') # 5402
#' pkvars <- c('41') # TA1
#' pkfecs <- c('93502') # 31/12/2020
#' datos_anuales <- getwsDatosAnualesRaw(idsesion,pkests,pkvars,pkfecs)
#' head(datos_anuales)
#' }
#'
...
#' @export
#'
getwsDatosAnualesRaw <- function(idsesion,pkests,pkvars,pkfecs) {
  ...
  main_node <- getNodeSet(body_node, ".//getDatosAnualesReturn")[[1]]

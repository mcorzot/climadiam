...
Obtención de fechas de ayer y antes de ayer: 

```{r example_full_dates, collapse=TRUE}
# Obtención de fechas a utilizar
date1 <- Sys.Date() - 1
...
# Selección de datos de TD1
datos_dia <- datos_diarios2[datos_diarios2$cvariable == 'TD2',]
